...
<html lang="en">
    ...
    <body>
        ...
        <div class="row">
            <div class="col-md-7">
              $body
              <a class="btn btn-default" href="get_started.html" style="margin-bottom:10px">Get Started <span class="glyphicon glyphicon-chevron-right"></span></a>
            </div>
            <div class="col-md-5">
        ...
        <div class="container">
            <div class="header fixed-top clearfix">
                <ul class="nav nav-pills">
                    ...
                    <li role="presentation"><h3 class="pull-right" role="presentation">Get Started</h3></li>
                </ul>
            </div>
...
doc = string.Template(TEMPLATE_DOC).safe_substitute(
        body=body, toc=toc, date=generated)
